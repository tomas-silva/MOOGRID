...
observer_files = os.listdir("/home/tomas/Masters/Sun_MOOG/Files_plansm.outtest")


# Só temos agora os ficheiros a começar por 'plansm'
plansm_files = filtro(all_files, 6, 'plansm')
sun_MgIb_file =  filtro(observer_files, 8, 'sun_MgIb')


set_comparar_temp = [5700, 5750, 5777, 5800]
set_comparar_logg = [4.44]
...
Test_set = (construct_list_filenames(set_comparar_temp, set_comparar_logg,
                                     set_comparar_metal, set_comparar_micro, ['Nuno','Sergio'])) #Extra nao pode começar por numero, a nao ser EXATAMENTE formato usual

#print(Test_set[-1])
plot_dados_comparar(Test_set, 'no_save','chi_quadrado',6,sun_MgIb_file[0])