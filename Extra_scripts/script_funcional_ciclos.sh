	...
	do
		...
		do
			...
			do
				...
				mv plan.outtest_$temp_formatado'_'$logg_formatado'_'$met_formatado'_'$micro_formatado ~/Masters/Sun_MOOG/Files_plan.outtest
				...
				mv planraw.outtest_$temp_formatado'_'$logg_formatado'_'$met_formatado'_'$micro_formatado ~/Masters/Sun_MOOG/Files_planraw.outtest
				...
				mv plansm.outtest_$temp_formatado'_'$logg_formatado'_'$met_formatado'_'$micro_formatado ~/Masters/Sun_MOOG/Files_plansm.outtest


				mv out_marcs_fromscript_$value_temp'_'$value_logg'_'$value_met'_'$value_micro.atm ~/Masters/Sun_MOOG/Files_atm
				mv synth_sun_fromscript_$value_temp'_'$value_logg'_'$value_met'_'$value_micro.par ~/Masters/Sun_MOOG/Files_par	
...
then
    mv out_marcs_fromscript_* ~/Masters/school_codes/interpol_models_marcs/Error_files_from_script
    mv synth_sun_fromscript_* ~/Masters/school_codes/interpol_models_marcs/Error_files_from_script
    mv plan.outtest_* ~/Masters/school_codes/interpol_models_marcs/Error_files_from_script
    mv planraw.outtest_* ~/Masters/school_codes/interpol_models_marcs/Error_files_from_script
    mv plansm.outtest_* ~/Masters/school_codes/interpol_models_marcs/Error_files_from_script
    echo " "
