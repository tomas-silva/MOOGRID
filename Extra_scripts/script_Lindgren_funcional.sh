...
declare -a min_wv=(11940.0) #11680.0
 
declare -a max_wv=(11995.0) #12920.0
		...
		do
			...
			do
				...
				do
					...
					echo $valor_min_wv_iter
					echo $valor_max_wv_iter
					...
					exec 3<> synth_fscript_$value_temp'_'$value_logg'_'$value_met'_'$value_micro'_Pr'.par # Se nome for maior dá erro, coding is a dark magic
						...
						echo '   n 0.01 1.7 0.6 3.5 0.0' >&3  # ? r 0.01 1.7 0.6 3.5 0.0' #r* nada afeta, excepto r0.01 que muda um pouco tamanho mas pouco relevante
