...
name_file_lines=$(echo 'linearticletest.list')
...
declare -a temperat=(3300)

declare -a logg=(4.96) #Não usar algo tipo '1.0', usar '1', '1.0' pode dar erro !!!

declare -a met=(-0.2 -0.1 0 0.1) #Não usar algo tipo '1.0', usar '1', '1.0' pode dar erro !!!

declare -a micro=(2) #Não usar algo tipo '1.0', usar '1', '1.0' pode dar erro !!!
		...
		do
			...
			do
				...
				exec 3<> synth_sun_fromscript_$value_temp'_'$value_logg'_'$value_met'_'$value_micro.par
					...
					echo 'flux/int    0' >&3
					echo 'synlimits' >&3
					echo '11600.0 11800.0 0.001 10.0' >&3 #
					echo 'plot        1' >&3		
					echo 'damping     0' >&3
					echo 'units       0' >&3
					echo 'molecules   2' >&3
					echo 'obspectrum  5' >&3
					echo 'plotpars 1' >&3
					echo '   11600.0 11800.0 -0.1  1.1' >&3 #??
